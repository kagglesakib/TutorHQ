      ...
      <header className="bg-emerald-950/95 backdrop-blur-xl border-b border-emerald-800/90 sticky top-0 z-[100] shrink-0 shadow-md relative" id="admin-dashboard-header">
        ...
        <div className="max-w-7xl mx-auto px-2.5 sm:px-4 py-1.5 flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            {/* Admin Profile Page Link (Replaces Refresh Button) */}
            <Link
              href="/admin/profile"
              className={`p-1.5 rounded-xl border transition-all cursor-pointer shadow-2xs shrink-0 flex items-center gap-1 ${
                pathname === '/admin/profile'
                  ? 'bg-emerald-700 text-white border-emerald-400 shadow-emerald-950/50'
                  : 'text-emerald-200 hover:text-white bg-emerald-900/80 hover:bg-emerald-800/90 border-emerald-700/80'
              }`}
