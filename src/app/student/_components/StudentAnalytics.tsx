      ...
      <div className="bg-white/80 p-3 sm:p-4 rounded-2xl border border-slate-200/90 shadow-2xs">
        {chartMode === 'exams' ? (
          examChartData.length > 0 ? (
            <div className="h-64 sm:h-72 w-full">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={examChartData} margin={{ top: 15, right: 15, left: 0, bottom: 5 }}>
                  <defs>
                        ...
                        return (
                          <div className="bg-slate-900 text-white p-3 rounded-xl shadow-lg text-xs space-y-1.5 border border-slate-700 min-w-[180px]">
                            ...
                            <div className="pt-1 border-t border-slate-700 flex items-center justify-between gap-4 font-mono">
                              ...
                              <span className="font-bold text-amber-400">{data.obtained} / {data.total} ({data.score}%)</span>
                            </div>
                          </div>
                        );
                      }
          ...
          attendanceChartData.length > 0 ? (
            <div className="h-64 sm:h-72 w-full">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={attendanceChartData} margin={{ top: 15, right: 15, left: 0, bottom: 5 }}>
                  <CartesianGrid strokeDasharray="3 3" stroke="#e2e8f0" vertical={false} />
                  <XAxis
                    dataKey="month"
                    tick={{ fontSize: 10, fill: '#64748b', fontWeight: 600 }}
